  ...
  async create(props) {
    try {
      ...
      props.userIds = props.userIds
        ? props.userIds.push(props.userId)
        : [props.userId];
      delete props.userId;
    ...
    carts.forEach((cart) => {
      if (cart.products) {
        ...
        cart.products.forEach((product) =>
          totalCartCost.push(parseFloat(product.value))
        );
        myProducts = cart.products.filter(
